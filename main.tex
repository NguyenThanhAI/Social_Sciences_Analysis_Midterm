...
\begin{loigiai}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\linewidth]{figures/overall_frequency.png}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\linewidth]{figures/overall_avg_child_field.png}
        \caption{Biểu đồ cột với trục hoành là giá trị của các trường và trục tung là phân phối số lượng trẻ em sinh trung bình của những người tham gia khảo sát có giá trị tương ứng trong trường được tính trên toàn tập dữ liệu}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\linewidth]{figures/overall_total_child_field.png}
        \caption{Biểu đồ cột với trục hoành là giá trị của các trường và trục tung là phân phối tổng số lượng trẻ em được sinh của những người tham gia khảo sát có giá trị tương ứng trong trường được tính trên toàn tập dữ liệu}
        \label{fig:overall_total_child_field}
    \end{figure}

    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\linewidth]{figures/considered_total_child_each_women_group.png}
        ...
        \begin{algorithm}[h!]
            ...
            \For{$i \gets 1$ \KwSty{to} $n$}{
                \For{$j \gets 1$ \KwSty{to} $m$} {
                    $pos_j \gets g(e_j) \times \dfrac{e_j^{x_i}}{x_i!}$\;
                }
