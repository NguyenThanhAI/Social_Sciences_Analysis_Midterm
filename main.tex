...
\begin{loigiai}
    ...
    \begin{enumerate}
        ...
        Ta giả định các quan sát (số con được sinh từ một người phụ nữ) là độc lập (các biến $X_i, i=1,2,\dots,n$ là các biến ngẫu nhiên độc lập và cùng tuân theo phân phối Poisson):
